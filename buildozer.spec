...
# (str) Package name
package.name = p4a_dev

# (str) Package domain (needed for android/ios packaging)
package.domain = com.bcdev

# (str) Source code where the main.py live
source.dir = src/app_launch

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,pyo,png,jpg,kv,atlas,toml
...
presplash.filename = %(source.dir)s/../data/icon_512.png
...
android.presplash_color = #88888a
...
android.permissions = android.permission.INTERNET, android.permission.ACCESS_NETWORK_STATE, com.google.android.gms.permission.AD_ID, android.permission.WAKE_LOCK
...
# (int) Android SDK version to use (will set automatically)
##android.sdk = 27
...
p4a.extra_args = --blacklist-requirements=buildozer,docutils --window
