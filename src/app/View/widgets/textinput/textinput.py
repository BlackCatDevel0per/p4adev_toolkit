...
.. Note:: :class:`~MDTextInput` inherited from
	...
	available in the :class:`~MDTextInput` class.

.. MDTextInput:
MDTextInput
-----------

:class:`~MDTextInput` can be with helper text and without.
...
.. Note:: :class:`~MDTextInputRect` inherited from
...
Clickable icon for MDTextInput
------------------------------
...
.. code-block:: python
	...
	class ClickableTextFieldRound(MDRelativeLayout):
		...
		# Here specify the required parameters for MDTextInputRound:
		# [...]
...
class MDTextInputRect(ThemableBehavior, TextInput):
	"""
...
class TextInputLabel(ThemableBehavior, Label):
	...
	# <kivymd.uix.textfield.MDTextInput object>
	...
	.. tabs::
		...
		.. tab:: Declarative python style
			...
			.. code-block:: python
				...
				from kivymd.uix.textfield import MDTextInput
